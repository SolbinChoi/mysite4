...
<script type="text/javascript" src="/mysite/assets/js/jquery/jquery-1.9.0.js">
</script>
<script>
	...
	$(function(){
		...
		$("#btn-checkemail").click(function(){
			...
			$.ajax({
				...
				"url" : "/mysite4/user?a=checkemail&email="+email,
				"type" : "get",
				"dataType" : "json",
				"data": "",
			...
			<div id="user">
				...
				<form id="join-form" name="joinForm" method="post" action="/mysite4/user/join">
					...
					<label class="block-label" for="email">이메일</label>
					 ...
					 <img id="image-checked" style="width:20px; display:none" src="/mysite4/assets/images/check.png"/>
